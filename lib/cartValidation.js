...
//        var cart = req.session.cart;
//        if (!cart) return next();
//        if (cart.tems.some(function (item) { return item.guests > item.product.maximumGuests; })) {
//            if (!cart.errors) cart.errors = [];
//            cart.errors.push('One or more of your selected tours ' + ' cannot accommodate the number of guests you' +
//                'have selected');
//        }
//        next();
//    }
